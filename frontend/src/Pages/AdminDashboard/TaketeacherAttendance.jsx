...
import { Calendar, CheckCircle, XCircle, ArrowLeft, User } from 'lucide-react';
...
const TaketeacherAttendance = () => {
    ...
    const handleOnSubmitAttendance = async (data) => {
        setLoading(true);
        try {
            const response = await axios.post(`https://college-management-system-s6xa.onrender.com/Teacher/TeacherAttendance/${teacherId}`, {
                status: data.status,
                date: data.date
            });
            if (response.data) {
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-2xl overflow-hidden">
                    <div className="p-6 border-b border-gray-700 bg-gray-800/50">
                        <h1 className="text-2xl font-bold text-center text-gray-100 mb-2">Mark Teacher Attendance</h1>

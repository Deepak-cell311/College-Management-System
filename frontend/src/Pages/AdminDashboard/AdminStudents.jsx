...
const AdminStudents = () => {
    ...
    const handleSearch = (e) => {
        ...
        const filtered = studentTodo.filter((student) =>
            String(student.name).toLowerCase().includes(e.target.value.toLowerCase()) || String(student.rollNum).toLowerCase().includes(e.target.value.toLowerCase())
        );

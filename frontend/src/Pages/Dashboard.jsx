    ...
    return (
        <>  <div className='bg-zinc-800 h-screen'>
            <div className=' w-full mx-auto flex px-10'>
                ...
                <div onClick={handleTeacherLogin} className='admin flex flex-col cursor-pointer justify-center items-center py-10 px-5 mt-10 mx-2 text-center shadow-3xl shadow-black border-2 border-gray-200 hover:bg-gradient-to-t from-blue-900 hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20 mb-2 text-white">
